        ...
        <div class="card-body p-4">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="short_description" class="form-control"
                   placeholder="One line summary shown in cards" value="<?= old('short_description') ?>">
          </div>
          <div class="mb-3">
          ...
          <div class="row g-3">
            ...
            <div class="col-md-6">
              ...
              <select name="price_label" class="form-select">
                <option value="month" <?= old('price_label') === 'month' ? 'selected' : '' ?>>/ month</option>
                <option value="year"  <?= old('price_label') === 'year'  ? 'selected' : '' ?>>/ year</option>
                <option value="once"  <?= old('price_label') === 'once'  ? 'selected' : '' ?>>one time</option>
              </select>
            </div>
          </div>
        </div>
      ...
      <div class="card border-0 shadow-sm rounded-3 mb-4">
        <div class="card-body p-4">
          ...
          <div class="d-flex align-items-center gap-3 mb-4">
            <div class="icon-preview" id="iconPreview" style="background:#1877f2;">
              <i class="bi bi-box-seam" id="iconEl"></i>
            </div>
          ...
          <div class="mb-3">
            ...
            <div class="input-group">
              ...
              <input type="text" name="icon" id="iconInput" class="form-control"
                     placeholder="bi-box-seam" value="<?= old('icon', 'bi-box-seam') ?>">
            </div>
            <div class="form-text">Find icons at <a href="https://icons.getbootstrap.com" target="_blank">icons.getbootstrap.com</a></div>
          </div>
          <div class="mb-3">
            <label class="form-label fw-semibold" style="font-size:14px;">Color</label>
            <div class="input-group">
              <input type="color" name="color" id="colorInput" class="form-control form-control-color" value="<?= old('color', '#1877f2') ?>">
              <input type="text" id="colorText" class="form-control" value="<?= old('color', '#1877f2') ?>" readonly>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card border-0 shadow-sm rounded-3 mb-4">
        <div class="card-body p-4">
          ...
          <div class="form-check form-switch">
            ...
            <label class="form-check-label" for="isFeatured" style="font-size:14px;">Featured (Most Popular)</label>
          </div>
        </div>
      </div>
